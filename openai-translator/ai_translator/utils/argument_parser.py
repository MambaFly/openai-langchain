...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument(
            '--model_type', type=str, help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')
        ...
        self.parser.add_argument(
            '--target_language', type=str, help='Translate to target language. Now supporting English(En) and Chinese(Ch)')
        self.parser.add_argument(
